...
class CodegenLoader extends AssetLoader{
  ...
  "location": "Location",
  "invalid_decimal_price": "Invalid decimal price",
  "item_description": "Write description here. Markdown is supported",
  "photos": "Your photos here. You can add them by direct link to image file. Make sure that image is public available.",
  "add_photo": "Add photo",
  "save": "Save",
...
static const Map<String,dynamic> ru = {
  ...
  "location": "Адрес",
  "invalid_decimal_price": "Неверное дробное число",
  "item_description": "Разместите описание здесь. Поддерживается формат Markdown",
  "photos": "Здесь вы можете добавить ваши фото с помощью прямой ссылки. Убедитесь, что ваше фото публично доступно.",
