...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> en = {
    ...
    "photos":
        "Your photos here. You can add them by direct link to image file. Make sure that image is public available.",
    "add": "Add",
    "save": "Save"
  };
  static const Map<String, dynamic> ru = {
    ...
    "item_description":
        "Разместите описание здесь. Поддерживается формат Markdown",
    "photos":
        "Здесь вы можете добавить ваши фото с помощью прямой ссылки. Убедитесь, что ваше фото публично доступно.",
    "add": "Добавить",
    "save": "Сохранить"
  };
